...
const EzVertexElement& EzD3DX9VertexDeclaration::addElement(unsigned short usSource, unsigned int uiOffset, EzVertexElement::EVertexElementType eType, 
...
void EzD3DX9VertexDeclaration::removeElement(unsigned int uiElem_index)
{
	m_bRebuild = true;
...
void EzD3DX9VertexDeclaration::modifyElement(unsigned int uiElem_index, unsigned short usSource, unsigned int uiOffset, EzVertexElement::EVertexElementType eType,
 EzVertexElement::EVertexElementSemantic eSemantic, u8 uIndex)
{
	m_bRebuild = true;
