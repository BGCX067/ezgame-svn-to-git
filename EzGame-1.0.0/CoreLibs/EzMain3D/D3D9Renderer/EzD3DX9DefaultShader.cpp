...
unsigned int EzD3DX9DefaultShader::beginPipeline(EzGeometry* pGeometry)
{
...
unsigned int EzD3DX9DefaultShader::updatePipeline(EzGeometry* pGeometry, EzPropertyState* pPropState)
{
	return constructPipeline(pGeometry, pPropState);
}

unsigned int EzD3DX9DefaultShader::endPipeline(EzGeometry* pGeometry)
{
	return 0;
}


unsigned int EzD3DX9DefaultShader::constructPipeline(EzGeometry* pGeometry, EzPropertyState* pPropState)
{
//	EzPropertyState* pPropState = pGeometry->getPropertyState();
