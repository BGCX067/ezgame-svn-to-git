...
EzD3DX9TextureStage::EzD3DX9TextureStage(IDirect3DDevice9* pID3DDevice, unsigned int uiMaxTextureBlendStages)
...
void EzD3DX9TextureStage::setTextureBlendStageCount(unsigned int uiStage)
{
	m_uiLastMaxTextureBlendStages = uiStage;
}


void EzD3DX9TextureStage::setTransform(unsigned int state, const EzMatrix4& mat)
{
...
void EzD3DX9TextureStage::disableStage(unsigned int uiStage)
{
...
void EzD3DX9TextureStage::texturePipeline(EzTextureStage* pTexStage)
{
	...
	unsigned int uiStage = pTexStage->getStage();
