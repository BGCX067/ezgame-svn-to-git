...
EzImage* EzTextureSource::createImageFromFile(const char* FileName)
{
	EzImage* pImage = 0;
...
EzTexture* EzTextureSource::loadTextureFromFile(const char* FileName)
{
	EzTexture* texture = 0;
...
EzTexture* EzTextureSource::createTexture(const char* filename)
{
...
EzTexture* EzTextureSource::findTexture(const char* filename)
{
	return NULL;
