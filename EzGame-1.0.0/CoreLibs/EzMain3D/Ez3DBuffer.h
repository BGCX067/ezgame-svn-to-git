...
public:
	...
	void readData(unsigned int uiOffset, unsigned int uiLength, void* pDest);
	void writeData(unsigned int uiOffset, unsigned int uiLength, const void* pSource, bool bDiscardWholeBuffer = false);
	void copyData(Ez3DBuffer& srcBuffer, unsigned int uiSrcOffset, unsigned int uiDstOffset, unsigned int uiLength, bool bDiscardWholeBuffer = false);

protected:
	/// Internal implementation of lock()
	virtual void* lockImpl(unsigned int uiOffset, unsigned int uiLength, ELockOptions eOptions) = 0;
	/// Internal implementation of unlock()
	virtual void unlockImpl(void) = 0;

protected:
	bool		m_bIsLock;
	unsigned int			m_uiSizeInBytes;
	EUsage		m_eUsage;
	unsigned int			m_uiLockStart;
	unsigned int			m_uiLockSize;
...
inline void Ez3DBuffer::readData(unsigned int uiOffset, unsigned int uiLength, void* pDest)
{
...
inline void Ez3DBuffer::writeData(unsigned int uiOffset, unsigned int uiLength, const void* pSource, bool bDiscardWholeBuffer)
{
...
inline void Ez3DBuffer::copyData(Ez3DBuffer& srcBuffer, unsigned int uiSrcOffset, unsigned int uiDstOffset, unsigned int uiLength, bool bDiscardWholeBuffer)
{
