...
*/
class EzImageLoaderBMP : public EzImageLoader
{
public:
...
private:
	...
	void decompress8BitRLE(unsigned char*& BmpData, int size, int width, int height, int pitch) const;

	void decompress4BitRLE(unsigned char*& BmpData, int size, int width, int height, int pitch) const;
};
