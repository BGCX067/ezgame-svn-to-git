...
void EzTextureStageGroup::setStageState(unsigned int uiState, unsigned int uiValue)
{
...
void EzTextureStageGroup::removeStageState(unsigned int uiState)
{
	EZASSERT(uiState < STAGEARRAYSIZE);
...
bool EzTextureStageGroup::getStageState(unsigned int uiState, unsigned int& uiValue)
{
	EZASSERT(uiState < STAGEARRAYSIZE);
...
void EzTextureStageGroup::setSamplerState(unsigned int uiState, unsigned int uiValue)
{
...
void EzTextureStageGroup::removeSamplerState(unsigned int uiState)
{
	EZASSERT(uiState < SAMPLERARRAYSIZE);
...
bool EzTextureStageGroup::getSamplerState(unsigned int uiState, unsigned int& uiValue)
{
	EZASSERT(uiState < SAMPLERARRAYSIZE);
