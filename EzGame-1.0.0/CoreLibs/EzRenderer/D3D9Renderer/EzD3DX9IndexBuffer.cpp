...
EzD3DX9IndexBuffer::EzD3DX9IndexBuffer(EzIndexBuffer::EIndexType eIndexType, u32 uiNumIndexes, Ez3DBuffer::EUsage eUsage,
...
void* EzD3DX9IndexBuffer::lockImpl(u32 uiOffset, u32 uiLength, Ez3DBuffer::ELockOptions eOptions)
{
	void* pBuf;
