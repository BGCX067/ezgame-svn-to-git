...
EzVertexBuffer* EzD3DX9BufferManager::createVertexBuffer(u32 uiStride, u32 uiNumVerts, Ez3DBuffer::EUsage eUsage, bool bUseSystemMemory)
{
	return (EzVertexBuffer*)EzNew EzD3DX9VertexBuffer(uiStride, uiNumVerts, eUsage, m_pID3DDevice, bUseSystemMemory);
}

EzIndexBuffer* EzD3DX9BufferManager::createIndexBuffer(EzIndexBuffer::EIndexType eType, u32 uiNumIndexes, Ez3DBuffer::EUsage eUsage,  bool bUseSystemMemory)
{
