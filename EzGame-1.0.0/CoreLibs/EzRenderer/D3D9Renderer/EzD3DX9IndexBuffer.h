...
public:
	EzD3DX9IndexBuffer(EzIndexBuffer::EIndexType eIndexType, u32 uiNumIndexes, Ez3DBuffer::EUsage eUsage, LPDIRECT3DDEVICE9 pDev, bool bUseSystemMemory);
...
protected:
	...
	virtual void* lockImpl(u32 uiOffset, u32 uiLength, Ez3DBuffer::ELockOptions eOptions);
