...
u32 EzRenderPass::ms_uiMaxTextureBlendStages = 2;
...
bool EzRenderPass::setStage(u32 uiStageNum, EzTextureStage* pStage)
{
...
{
	for(u32 uiStageNum = 0 ; uiStageNum < ms_uiMaxTextureBlendStages; uiStageNum++)
	{
